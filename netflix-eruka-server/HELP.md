...
* The original package name 'com.babs.microservice.netflix-eruka-server' is invalid and this project uses 'com.babs.microservice.netflixerukaserver' instead.
